...
DEST_PATHS = {
    "train_taco.json": os.path.expanduser("../../data/deepcoder/train/taco.json"),
    "olympiad.json": os.path.expanduser("../../data/deepcoder/train/math/olympiad.json"),
    "test_livecodebench.json": os.path.expanduser("../../data/deepcoder/test/code/livecodebench.json"),
    "train_livecodebench.json": os.path.expanduser("../../data/deepcoder/train/code/livecodebench.json"),
    "kodcode.json": os.path.expanduser("../../data/deepcoder/train/code/kodcode.json"),
    "primeintellect.json": os.path.expanduser("../../data/deepcoder/train/code/primeintellect.json"),
}
